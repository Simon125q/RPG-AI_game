...
class Upgrade:
    ...
    def selection_cooldown(self):
        if not self.can_move:
            ...
            if current_time - self.selection_time >= self.select_cooldown:
                self.can_move = True            
...
class Item:
    ...
    def display_bar(self, surface, value, max_value, selected):
        ...
        bar_height = (value / max_value) * full_height
        bar_rect = pygame.Rect(top[0] - 15, bottom[1] - bar_height, 30, 10)
